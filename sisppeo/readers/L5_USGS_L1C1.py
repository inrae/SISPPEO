...
"""This module contains a reader for L5_USGS_L1C1 products with tif files.

    Typical usage example:

    reader = L5USGSL1C1Reader(**config)
...
class L5USGSL1C1Reader(Reader):
    ...
    def __init__(self, input_product: Path, requested_bands: List[str], **_ignored):
        super().__init__(input_product=input_product, requested_bands=requested_bands,
                         names_dict=names_dict_l457l1c1, **_ignored)
