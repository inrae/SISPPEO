...
"""In this module is defined the CLI of SISPPEO (powered by click)."""
...
from sisppeo.utils.cli import (PathPath, Mutex, read_products_list,
...
@click.option('--product_type', type=click.Choice(list(sat_products)),
              required=True,
...
def create_l3algo(input_product, product_type, theia_bands, theia_masks,
    ...
    """Creates one or more L3 products (one per algo) from a L1-2 one."""
    config = {
