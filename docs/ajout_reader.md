# Écrire et ajouter un nouveau reader à SISPPEO
...
Par défaut, les arguments nécessaire dans l'*\_\_init\_\_* sont les suivants :
...
d'étape 1 (pas de dataset à charger, uniquement un fichier de métadaonnés à
...
### 3.4 renseigner les métadonnées.

Il faut les enregistrer dans le dictionnaire *attrs* du dataset.
